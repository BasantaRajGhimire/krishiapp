...
class ClientTicketTitleController extends Controller {
    ...
    public function index() {
        return view('admin.client_ticket_title.index');
        }
    public function showList(Request $request){
        return view('admin.client_ticket_title.list');
    }
    public function listData(Request $request) {
        $model = new ClientTicketTitle();
    ...
    public function create() {
        $models = ClientTicketCategory::all();
        return view('admin.client_ticket_title.create')->withCategory( $models);
    }
    ...
    public function edit($id) {
        $model = ClientTicketTitle::find($id);
