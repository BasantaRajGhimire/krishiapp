...
<head>
  ...
  <link rel="stylesheet" href="<?php echo asset('css/db.css');?>">
  ...
  <link rel="stylesheet" href="<?php echo asset('css/jqtree.css');?>">
  ...
  <script type="text/javascript" src="<?php echo asset('js/tree.jquery.js');?>"></script>
  <script src="<?php echo asset('js/jquery.file-manager.js'); ?>" type="text/javascript"></script>