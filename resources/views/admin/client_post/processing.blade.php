    ...
    <div id="second-content-section" class="col-md-12">
    	<div class="box col-md-6">
            <div class="box-header with-border">
                <h3 class="box-title">List of Processing Bid Posts</h3>
...
function createTable(resp){
    createDataTablePost('material-table',resp,['name','phone_number','category','address','estimated_cost','duration_days','email'],'id');
}
    ...
    if ($('#' + domId).length) {
        ...
        if (data.length) {
            ...
            for (var i in data) {
                ...
                if (actions != 1) {
                    row.insertCell(fields.length).innerHTML = "<a href='javascript:void(0)' onclick=\"details('" + data[i][pk] + "')\" class='btn btn-xs btn-info'>Details</a>";
                }
                if (sn == 1) {
