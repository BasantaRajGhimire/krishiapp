...
<div class="box box-primary">
				<div class="box-header with-border">
				  <h3 class="box-title">Add Material Type</h3>
				</div>
				...
				<div class="box-body">
					<div class="form-group">
						<label for="material_type_name">Material Name</label>
					...
					<div class="form-group">
						<label for="material_type_name">Type Name</label>
					  	<input type="text" name='material_type_name' id='material_type_name' class="form-control"  >
					</div>
					<div class="form-group">
