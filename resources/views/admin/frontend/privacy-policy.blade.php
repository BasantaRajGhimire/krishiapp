...
<div class="row">
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-default">
            <div class="panel-heading">Add/Edit Privacy & Policy Page</div>
            <div class="panel-body">
                <form id="pp-form" class="form-horizontal" role="form" method="POST" action="{{ url('/admin/frontend') }}" onsubmit="formSubmit(event);">
                    {!! csrf_field() !!}
...
function formSubmit(e){
    ...
    var formData = $('form').serialize()+'&slug=PP';
    if(id !=''){
