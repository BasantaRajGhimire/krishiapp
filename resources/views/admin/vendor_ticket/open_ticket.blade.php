...
<script>
    var baseUrl = "<?php echo url('admin/serviceprovider-ticket/open'); ?>";
    ...
    function createTable(resp) {
        createOpenTicketTable('material-table', resp, ['ticket_id', 'vendor_name', 'name', 'title','message','screenshot','created_at'], 'id');
    }
