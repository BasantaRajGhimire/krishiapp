...
<script>
    var baseUrl = "<?php echo url('admin/client-ticket/closed'); ?>";
function table(){
    var url = "list-data";
...
function createTable(resp){
    createClosedTicketTable('material-table',resp,['ticket_id','client_name','name','title','message','updated_at'],'id',0,1);
}
