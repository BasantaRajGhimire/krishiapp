...
<script>
    var baseUrl = "<?php echo url('admin/client-ticket/processing'); ?>";
    ...
    function createTable(resp) {
        createProcessingTicketTable('material-table', resp, ['ticket_id', 'client_name', 'name', 'title','message','screenshot','updated_at'], 'id',0,1);
    }
