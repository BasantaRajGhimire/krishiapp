<div class="box col-md-6">
                    <div class="box-header with-border">
                        <h3 class="box-title">List of Bagde</h3>
...
function createTable(resp){
    createDataTable('material-table',resp,['name'],'id');
}
...
function delt(id){
    alert('Sorry, your request cannot be done because this is a reserved badge.');
}
table();
