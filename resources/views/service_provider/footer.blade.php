...
<div id="loader-animation"
     style="position: fixed;width: 100%;height: 100%;left: 0;top: 0;z-index: 99999;  opacity: 1;display: none;background-color:#0000001a">
    <div style="display: table; margin: 0 auto;width: 120px;position: fixed;top: 45%;left: 45%;padding:0px 40px;background-color: #4440;border-radius: 0.5em;">
        <ion-spinner icon="ios" class="spinner spinner-ios" style="width: 35px; float:left; stroke: #fff;fill: #fff;">
            <svg class="lds-gear" width="70px" height="70px" xmlns="http://www.w3.org/2000/svg"
                 xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid"
                 style="shape-rendering: auto; animation-play-state: running; animation-delay: 0s; background: rgba(255, 255, 255, 0) none repeat scroll 0% 0%;">
