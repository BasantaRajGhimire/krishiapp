    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                @endif
                @if(session('ticket-err'))
                    <div class="alert alert-danger">
                        {{session('ticket-err')}}
                    </div>
                @endif
                <form class="form-horizontal" role="form" method="POST" action="{{ url('/service-provider/support-ticket') }}" enctype="multipart/form-data">
                    {!! csrf_field() !!}
...
<script>    
    ...
    function getTitle(categoryid){
        ...
        url = url + '/support-ticket/'+categoryid+'/get-title';
