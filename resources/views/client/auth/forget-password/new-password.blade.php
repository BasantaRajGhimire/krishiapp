                    ...
                    <div class="col-5 mx-auto">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form class="mt-3 mb-3" id="loginForm" method="post"
                                    onsubmit="validatePassword(event, this)">
                                    @csrf
                                    <div class="form-group">
                                        ...
                                        <div class="red text-center {{$errors->has('email')?'show':'hide'}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="red text-center {{$errors->has('new_password')?'show':'hide'}}">
                                            *{{$errors->has('new_password')?$errors->first('new_password'):'' }}</div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="red text-center {{$errors->has('confirm_password')?'show':'hide'}}">
  ...
  <script type="text/javascript">
    function validatePassword(e,t){
      ...
      if (errors.length > 0) {
        ...
        $(t).attr('action',"{{url('/client').'/auth/token/'.$token}}")
        t.submit();
      }
  }
  </script>